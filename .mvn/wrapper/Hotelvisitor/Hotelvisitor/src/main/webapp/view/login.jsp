...
<body>
	...
	<div class="container">
		<form action="/userhome" method="post" modelAttribute="user">
			<div class="row">
				...
				<div class="col">
					...
					<input type="text" name="name" placeholder="Username" required path=name>
					<input type="password" name="password" placeholder="Password" path="passowrd"
